...
type Bootstrap struct {
	...
	Server *Server `protobuf:"bytes,1,opt,name=server,json=server,proto3" json:"server"`
	Data   *Data   `protobuf:"bytes,2,opt,name=data,json=data,proto3" json:"data"`
}
...
type Server struct {
	...
	Http *Server_HTTP `protobuf:"bytes,1,opt,name=http,json=http,proto3" json:"http"`
	Grpc *Server_GRPC `protobuf:"bytes,2,opt,name=grpc,json=grpc,proto3" json:"grpc"`
}
...
type Data struct {
	...
	Database *Data_Database `protobuf:"bytes,1,opt,name=database,json=database,proto3" json:"database"`
	Redis    *Data_Redis    `protobuf:"bytes,2,opt,name=redis,json=redis,proto3" json:"redis"`
	Jwt      *Data_JWT      `protobuf:"bytes,3,opt,name=jwt,json=jwt,proto3" json:"jwt"`
}
...
type Server_HTTP struct {
	...
	Timeout *durationpb.Duration `protobuf:"bytes,3,opt,name=timeout,json=timeout,proto3" json:"timeout"`
}
...
type Data_Redis struct {
	...
	Network      string               `protobuf:"bytes,1,opt,name=network,json=network,proto3" json:"network"`
	Addr         string               `protobuf:"bytes,2,opt,name=addr,json=addr,proto3" json:"addr"`
	ReadTimeout  *durationpb.Duration `protobuf:"bytes,3,opt,name=read_timeout,json=readTimeout,proto3" json:"read_timeout"`
	WriteTimeout *durationpb.Duration `protobuf:"bytes,4,opt,name=write_timeout,json=writeTimeout,proto3" json:"write_timeout"`
}
...
type Data_JWT struct {
	...
	AccessSecret             string `protobuf:"bytes,1,opt,name=access_secret,json=accessSecret,proto3" json:"access_secret"`
	AccessTokenExpireMinutes int64  `protobuf:"varint,2,opt,name=access_token_expire_minutes,json=accessTokenExpireMinutes,proto3" json:"access_token_expire_minutes"`
}
...
func (x *Data_JWT) GetAccessTokenExpireMinutes() int64 {
	if x != nil {
		return x.AccessTokenExpireMinutes
	}
	return 0
}
...
var file_conf_conf_proto_rawDesc = []byte{
	...
	0x74, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x22, 0xf0, 0x03, 0x0a, 0x04, 0x44, 0x61, 0x74, 0x61,
	...
	0x72, 0x65, 0x64, 0x69, 0x73, 0x12, 0x26, 0x0a, 0x03, 0x6a, 0x77, 0x74, 0x18, 0x03, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x14, 0x2e, 0x6b, 0x72, 0x61, 0x74, 0x6f, 0x73, 0x2e, 0x61, 0x70, 0x69, 0x2e,
	0x44, 0x61, 0x74, 0x61, 0x2e, 0x4a, 0x57, 0x54, 0x52, 0x03, 0x6a, 0x77, 0x74, 0x1a, 0x3a, 0x0a,
	...
	,
...
var file_conf_conf_proto_goTypes = []interface{}{
	...
	(*Data_JWT)(nil),            // 7: kratos.api.Data.JWT
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	7,  // 6: kratos.api.Data.jwt:type_name -> kratos.api.Data.JWT
