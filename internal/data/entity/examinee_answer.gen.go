...
type ExamineeAnswer struct {
	...
	IsCompleted         bool           `gorm:"column:is_completed;not null;comment:是否完成" json:"is_completed"`                                   // 是否完成
	IsReaded            bool           `gorm:"column:is_readed;not null;comment:是否已读" json:"is_readed"`                                         // 是否已读
	RemainingTimelimit  int32          `gorm:"column:remaining_timelimit;not null;comment:考试剩余时长" json:"remaining_timelimit"`                   // 考试剩余时长
	HasPdf              bool           `gorm:"column:has_pdf;not null;comment:是否有PDF" json:"has_pdf"`                                           // 是否有PDF
