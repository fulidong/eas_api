...
type SalesPaperDimension struct {
	...
	SalesPaperID    int32          `gorm:"column:sales_paper_id;comment:售卷表外键" json:"sales_paper_id"`                           // 售卷表外键
	DimensionID     int32          `gorm:"column:dimension_id;comment:维度表外键" json:"dimension_id"`                               // 维度表外键
