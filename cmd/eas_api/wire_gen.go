...
func wireApp(confServer *conf.Server, confData *conf.Data, logger log.Logger) (*kratos.App, func(), error) {
	...
	easSalesPaperService := service.NewEasSalesPaperService(userUseCase, salesPaperUseCase, salesPaperCommentUseCase, salesPaperDimensionUseCase, salesPaperDimensionCommentUseCase)
