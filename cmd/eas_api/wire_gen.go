...
func wireApp(confServer *conf.Server, confData *conf.Data, logger log.Logger) (*kratos.App, func(), error) {
	...
	examineeSalesPaperAssociationUseCase := biz.NewExamineeSalesPaperAssociationUseCase(examineeSalesPaperAssociationRepo, userUseCase, salesPaperUseCase, examineeUseCase, logger)
	easExamineeService := service.NewEasExamineeService(userUseCase, examineeUseCase, examineeSalesPaperAssociationUseCase)
