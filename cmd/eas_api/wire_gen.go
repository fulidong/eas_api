...
func wireApp(confServer *conf.Server, confData *conf.Data, logger log.Logger) (*kratos.App, func(), error) {
	...
	salesPaperUseCase := biz.NewSalesPaperUseCase(salesPaperRepo, userRepo, logger)
	salesPaperCommentRepo := data.NewSalesPaperCommentRepo(dataData, logger)
	salesPaperCommentUseCase := biz.NewSalesPaperCommentUseCase(salesPaperCommentRepo, userRepo, logger)
	easService := service.NewEasService(loginUseCase, userUseCase, salesPaperUseCase, salesPaperCommentUseCase)
